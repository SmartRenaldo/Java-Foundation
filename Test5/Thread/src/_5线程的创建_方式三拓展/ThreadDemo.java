...
public class ThreadDemo {
    public static void main(String[] args) {
        ...
        // 5.把未来任务对象包装成线程对象
        Thread thread1 = new Thread(task, "1st thread");
        // 6.启动线程对象
        thread1.start();
        Thread thread2 = new Thread(task, "2nd thread");
        thread2.start();
...
class MyCallable implements Callable<String> {
    ...
    public String call() throws Exception {
        ...
        return "Result of " + Thread.currentThread().getName() + " is " + sum;
    }
}