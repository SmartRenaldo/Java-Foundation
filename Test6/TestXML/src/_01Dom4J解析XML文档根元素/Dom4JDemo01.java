...
public class Dom4JDemo01 {
    public static void main(String[] args) throws Exception {
        ...
        //Document document = saxReader.read(new File("TestXML\\xml\\demo04_schema.xml"));

        // 3.第二种方式（代码多点）先把xml文件读成一个字节输入流
        // 这里的“/”是直接去src类路径下寻找文件。
        InputStream is = Dom4JDemo01.class.getResourceAsStream("/demo04_schema.xml");
