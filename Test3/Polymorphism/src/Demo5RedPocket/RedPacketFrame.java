...
public abstract class RedPacketFrame extends JFrame {
    ...
    // 设置字体
    private static Font fontYaHei = new Font("SourceHanSansCN-Bold", Font.BOLD, 20);
    private static Font msgFont = new Font("SourceHanSansCN-Bold", Font.BOLD, 20);
    private static Font totalShowFont = new Font("SourceHanSansCN-Bold", Font.BOLD, 40);
    private static Font nameFont = new Font("SourceHanSansCN-Bold", Font.BOLD, 40);
    private static Font showNameFont = new Font("SourceHanSansCN-Bold", Font.BOLD, 20);
    private static Font showMoneyFont = new Font("SourceHanSansCN-Bold", Font.BOLD, 50);
    private static Font showResultFont = new Font("SourceHanSansCN-Bold", Font.BOLD, 15);
        ...
        input_inMoney.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    System.out.println("Total：[" + totalMoney + "]AUD");
